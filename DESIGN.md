...
2. **BreveText**, the proprietary humanist serif used for long-form body, bylines, and editorial captions. Used at 16  to  19 px line-height 1.45  to  1.50 for comfortable reading density.
...
- **BreveText**, *Lora* or *Source Serif Pro* at 16  to  19 px.
...
| Tablet | 768 to 1023px | 2-up secondary story grid. |
